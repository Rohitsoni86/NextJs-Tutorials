          ...
          <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex flex-col items-center">
                  ...
                  <h1 className="text-xl font-bold">Rohit Soni</h1>
                  <p className="text-gray-700">Software Developer</p>
                  <div className="mt-6 flex flex-wrap gap-4 justify-center">
                    <Link href="#" className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Contact</Link>
            ...
            <div className="col-span-4 sm:col-span-9">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <p className="text-gray-700">Enthusiastic and adaptable fresher in software engineering, eager to embark on a journey of learning and professional
                  growth. Armed with a strong foundation in programming and problem-solving, I'm excited to collaborate with dynamic
                  teams to tackle challenges and deliver innovative solutions. Committed to staying updated with industry trends, I'm
                  poised to contribute effectively and evolve in a fast-paced software development environment."
                </p>
